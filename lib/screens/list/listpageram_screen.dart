...
class ListPageRam extends StatefulWidget {
  @override
  _ListPageRamState createState() => _ListPageRamState();
}

class _ListPageRamState extends State<ListPageRam> {
  int _currentIndex = 1;
  String selectedCategory = 'ram';
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: Container(
              height: 400, 
              child: FutureBuilder<Ram>(
                future: network.fetchRam(),
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DetailBarangRamPage(data: currentData,),
                          ),
                        );
                      },
                      trailing: IconButton(
