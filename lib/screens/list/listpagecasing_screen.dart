...
import 'package:market/screens/list/detail/detailcasing_screen.dart';
...
class ListPagecasing extends StatefulWidget {
  @override
  _ListPagecasingState createState() => _ListPagecasingState();
}

class _ListPagecasingState extends State<ListPagecasing> {
  int _currentIndex = 1;
  String selectedCategory = 'casing';
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: Container(
              height: 400, 
              child: FutureBuilder<Casing>(
                future: network.fetchCasing(),
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DetailBarangCasingPage(data: currentData,),
                          ),
                        );
                      },
                      trailing: IconButton(
