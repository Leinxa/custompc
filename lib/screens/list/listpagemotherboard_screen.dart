...
import 'package:market/screens/list/detail/detailmotherboard_screen.dart';
...
class ListPagemotherboard extends StatefulWidget {
  @override
  _ListPagemotherboardState createState() => _ListPagemotherboardState();
}

class _ListPagemotherboardState extends State<ListPagemotherboard> {
  int _currentIndex = 1;
  String selectedCategory = 'motherboard';
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: Container(
              height: 400, 
              child: FutureBuilder<Motherboard>(
                future: network.fetchMotherboard(),
                builder: (context, snapshot) {
                  if(snapshot.hasData){
                    ...
                    child: ListTile(
                      ...
                      title: Text(currentData.nama),
                      subtitle: Text('Rp: '+currentData.price.toString()),
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DetailBarangMotherboardPage(data: currentData,),
                          ),
                        );
                      },
                      trailing: IconButton(
