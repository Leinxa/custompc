...
import 'package:market/screens/list/detail/detailcooler_screen.dart';
...
class ListPagecooler extends StatefulWidget {
  @override
  _ListPagecoolerState createState() => _ListPagecoolerState();
}

class _ListPagecoolerState extends State<ListPagecooler> {
  int _currentIndex = 1;
  String selectedCategory = 'cooler';
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: Container(
              height: 400, 
              child: FutureBuilder<Cooler>(
                future: network.fetchCooler(),
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DetailBarangCoolerPage(data: currentData,),
                          ),
                        );
                      },
                      trailing: IconButton(
